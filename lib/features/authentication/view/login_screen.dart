...
import 'package:your_venue_manager/features/dashboard/view/home_screen.dart';
...
import 'package:your_venue_manager/features/authentication/view_model/cubit/password_visibility/password_visibility_cubit.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocListener<ManagerAuthBloc, ManagerAuthState>(
        listener: (context, state) {
          if (state is ManagerLoginSuccess) {
          ...
          if (state is ManagerLoginPending) {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => const AccountPendingVerificationScreen(),
              ),
            );
          }
